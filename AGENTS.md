...
- The current goal is to strengthen the existing closed-loop evidence pipeline:
  synchronized RGB / semantic / depth evidence, cross-modal consistency checks,
  and a longer but bounded normal rollout.
